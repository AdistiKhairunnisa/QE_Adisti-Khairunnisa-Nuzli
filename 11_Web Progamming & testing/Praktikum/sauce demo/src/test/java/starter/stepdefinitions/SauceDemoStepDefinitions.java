...
public class SauceDemoStepDefinitions extends UIInteractions {
    ...
    public void userInputValidEmailOnFieldEmail(Actor actor, String string) {
        actor.attemptsTo(DoActionSauceDemo.fillUsername(string));
    }
    ...
    public void userInputValidPasswordOnFieldPassword(Actor actor, String string) {
        actor.attemptsTo(DoActionSauceDemo.fillPassword(string));
    }
    ...
    public void userInputInvalidUsernameOnFieldUsername(Actor actor, String string) {
        actor.attemptsTo(DoActionSauceDemo.fillUsername(string));
    }
