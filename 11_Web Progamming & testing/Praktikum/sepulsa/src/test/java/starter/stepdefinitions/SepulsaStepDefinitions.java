...
import starter.helper.DoActionSepulsa;
...
public class SepulsaStepDefinitions {
    ...
    public void userInputValidEmailOnFieldEmail(Actor actor, String string) {
        actor.attemptsTo(DoActionSepulsa.fillUsername(string));
    }

    @And("{actor} input valid password on field password {string}")
    public void userInputValidPasswordOnFieldPassword(Actor actor, String string) {
        actor.attemptsTo(DoActionSepulsa.fillPassword(string));
    }
    ...
    public void userInputInvalidEmailOnFieldEmail(Actor actor, String string) {
        actor.attemptsTo(DoActionSepulsa.fillUsername(string));
    }

    @And("{actor} input invalid password on field password {string}")
    public void userInputInvalidPasswordOnFieldPassword(Actor actor, String string) {
        actor.attemptsTo(DoActionSepulsa.fillPassword(string));
    }
